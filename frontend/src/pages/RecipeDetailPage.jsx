...
import { addReview } from "../services/recipeService";
...
}) 
{
  ...
  const isOwner = selectedRecipe.user === currentUser?.id;
  ...
  try {
    await addReview(selectedRecipe._id, {
      rating,
      comment,
    });
            ...
            <div className="p-8 overflow-y-auto h-[650px]">
              <div className="flex justify-between items-start mb-6">
                <div><h1 className="text-4xl font-bold text-gray-800 mb-4">{selectedRecipe.title}</h1>
                  ...
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="text-gray-600">({selectedRecipe.reviews.length} reviews)</span>
                  </div>
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-3">{selectedRecipe.ingredients.map((ingredient, index) => (
                ...
                <div>
                  ...
                  <div className="space-y-5">{selectedRecipe.instructions.map((instruction, index) => (
                ...
                {!isOwner && (
                  <div className="mt-10 border-t pt-8">
                    ...
                    <div className="mb-4">
                      ...
                      <select value={rating} onChange={(e) => setRating(Number(e.target.value))} className="w-full p-3 border rounded-lg">
                    ...
                    <div className="mb-4">
                      ...
                      className="w-full p-3 border rounded-lg" placeholder="Write your review..."/>
                    </div>
                    <button onClick={handleReviewSubmit} className="bg-rose-600 hover:bg-rose-700 text-white px-6 py-3 rounded-lg">
                      Submit Review
                    </button>
                  </div>)}
